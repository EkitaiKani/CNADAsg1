...
func (h *ReserveAPI) CompletedReservations(w http.ResponseWriter, r *http.Request) {
...
func (h *ReserveAPI) EndReservation(w http.ResponseWriter, r *http.Request) {
	// Decode the incoming JSON request body
	var res *models.Reservation
	decoder := json.NewDecoder(r.Body)
	if err := decoder.Decode(&res); err != nil {
